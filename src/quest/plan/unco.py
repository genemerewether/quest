...
class QRPolyTrajGUI(QWidget):
    def __init__(self,
        ...
        ui_file = os.path.join(rospkg.RosPack().get_path('quest'),
...
def main():
    from quest.plan.unco import QRPolyTrajGUI
